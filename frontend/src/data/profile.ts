...
export const profile: Profile = {
  ...
  nameFirst: 'John',
  nameLast: 'Tran',
  title: 'Business Designer & Builder',
  positioning:
    'I work at the intersection of business, technology, and people — using design thinking and technical skills to turn ambiguous problems into products and strategies that actually work.',
  bio:
