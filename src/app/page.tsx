  ...
  return (
    <>
      <header className="hero">
        <div className="wrap heroInner">
          ...
          <p className="heroLede">
            ...
            trends, opportunities, and risks — grounded in the sources, updated on demand.
          </p>
      ...
      <main className="signals">
        <div className="wrap">
          ...
          <p className="disclaimer">
            Signalstockholm is automated research generated by an AI model reading public news
            feeds. It is <strong>not financial advice</strong> and may be inaccurate or incomplete.
            Verify every claim against primary sources before acting.
          </p>
        </div>
      </main>
      ...
      <footer className="foot">
        <div className="wrap">
          Signalstockholm · Built for johntran.dev · Design system after vinnova.se
        </div>
      </footer>
    </>
  );
